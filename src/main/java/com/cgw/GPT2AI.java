...
/**
 * Testing Class for a cURL command to the HuggingFace GPT2 inference API.
 * Found at: "https://huggingface.co/gpt2"
 * @author Luke Burston
...
public class GPT2AI {
    ...
    public static String cURLTest(String prompt) throws IOException {
        String command = "curl https://api-inference.huggingface.co/models/gpt2 -X POST -d '{\""
